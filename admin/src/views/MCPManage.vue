...
const leftPanelSize = ref<string | number>('33%')
...
<template>
  <div class="h-full w-full flex flex-col gap-1">
    ...
    <div class="flex-1 min-h-0">
      <ElSplitter class="h-full" layout="horizontal">
        <!-- Left: Server List -->
        <ElSplitterPanel v-model:size="leftPanelSize" collapsible min="250" class="overflow-hidden">
          <div class="h-full flex flex-col gap-4 overflow-y-auto pr-2 pb-2">
            <ElCard 
        ...
        <!-- Right: Details & Tools -->
        <ElSplitterPanel min="400" class="overflow-hidden">
          <div class="h-full overflow-y-auto pr-2 pb-2 pl-4">
                ...
                <div v-else class="grid grid-cols-1 gap-4">
                  ...
                  >
                    <div class="flex flex-col gap-2">
                      ...
                      <p class="text-sm text-muted-foreground">{{ getLocalizedText(tool.description, locale) }}</p>
